...
2. Обработка всех возможных пар a, b (всего их девять случаев поскольку для каждого числа а есть три варианта числа b (число равно 0, число больше 0, число меньше 0))
